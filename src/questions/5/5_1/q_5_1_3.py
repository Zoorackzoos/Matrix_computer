...
def q_5_1_3(tab_amount="\t"):
    ...
    swap_rows(matrix_in_question=matrix_in_question, row_1=3, row_2=2, tab_amount=tab_amount)
    print_matrix(matrix_in_question=matrix_in_question, tab_amount=tab_amount)
    swap_rows(matrix_in_question=matrix_in_question, row_1=3, row_2=1, tab_amount=tab_amount)
    print_matrix(matrix_in_question=matrix_in_question, tab_amount=tab_amount)
    swap_rows(matrix_in_question=matrix_in_question, row_1=3, row_2=0, tab_amount=tab_amount)
    print_matrix(matrix_in_question=matrix_in_question, tab_amount=tab_amount)
