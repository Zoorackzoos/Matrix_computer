...
def get_list_with_REF_and_return_determinant_values(matrix_in_question, tab_amount="\t"):
    ...
    1. return value is a list that contains
        a. REF matrix
        b. operations used to get that REF matrix
    ...
    determinant_operation_values_list = []
    return_list = [matrix_in_question,determinant_operation_values_list]
    ...
    while row_index_a < num_of_rows:
        ...
        while row_index_b < num_of_rows:
            ...
            if matrix_in_question[row_index_a] == matrix_in_question[row_index_b]:
                ...
                determinant_operation_values_list.append( (f"1/{old_matrix_in_question[row_index_b][column_index_shared]}") )
                determinant_operation_values_list.append( (f"1/{old_matrix_in_question[row_index_a][column_index_shared]}") )
                ...
                if both_rows_positive or both_rows_negative:
                    ...
                    determinant_operation_values_list.append("-1")
                else:
                    print(tab_amount+"\t\t\t","they were opposite signs so no operation needed.")
